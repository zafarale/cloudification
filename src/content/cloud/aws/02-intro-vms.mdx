...
flowchart TD
    ...
    accDescr: Flowchart (td) showing Pending Provisioning resources Not billed, Running Billed per second, Stopping Shutting down OS
    PENDING["Pending<br/>Provisioning resources<br/>Not billed"]
    RUNNING["Running<br/>fa:fa-check Billed per second"]
    STOPPING["Stopping<br/>Shutting down OS"]
    STOPPED["Stopped<br/>EBS volumes billed<br/>No CPU/memory charge"]
    HIBERNATE["Hibernating<br/>RAM saved to EBS<br/>Faster resume"]
    TERMINATE["Shutting Down<br/>Final state"]
    TERMINATED["Terminated<br/>fa:fa-trash Not billed<br/>EBS deleted (default)"]
    REBOOT["Reboot<br/>Stays running, same host<br/>No billing gap"]
